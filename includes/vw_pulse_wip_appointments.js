// includes/vw_pulse_wip_appointments.js
module.exports = (companyId, projectId, rawDataset) =>
  publish("vw_pulse_wip_appointments", {
    type: "view",
    database: projectId,
    schema: "dashboards",
    description: "View PULSE WIP APPOINTMENTS",
    tags: ["dashboards", "dailytracker", "vw_pulse_wip_appointments"]
  })
    .query(`
